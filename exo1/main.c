...
int main() {
    ...
    double t,start,stop;
    double* matrice_A = (double*) malloc(SIZE*SIZE*sizeof(double));
    double* matrice_B = (double*) malloc(SIZE*SIZE*sizeof(double));
    double* matrice_res = (double*) malloc(SIZE*SIZE*sizeof(double));
